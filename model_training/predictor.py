...
class BugPredictor:
    ...
    def analyze_zip(self, zip_path: str, extract_to: str = None, overwrite: bool = True) -> list:
        """
        ...
        file_records = extract_metrics_from_zip(zip_path, extract_to=extract_to, overwrite=overwrite)
        all_bugs     = []
        bug_id       = 1
